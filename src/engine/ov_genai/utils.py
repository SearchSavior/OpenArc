...
def generate_ov_scheduler_config(scheduler_config: SchedulerConfigSchema) -> dict:
  ...
  # SchedulerConfig cannot be used as SDPA pipelines refuse to accept a scheduler config 
  # which includes any invalid properties, including those set to `None` by default.
  # Fortunately, the pipelines also accept a dictionary.
  sched_config = {}
