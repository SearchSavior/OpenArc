...
Welcome to OpenArc codebase documentation! This section covers the internal architecture, APIs, and design patterns.
...
- **[OpenVINO IR](openvino_ir.md)** - OpenVINO Intermediate Representation format
