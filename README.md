...
Instead of fighting with Intel's own docker images, we built our own which is as close to boilerplate as possible. If you need a primer on docker [check out this video](https://www.youtube.com/watch?v=DQdB7wFEygo).
