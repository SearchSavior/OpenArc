...
# ============================================================================
RUN uv sync && \
        uv pip install optimum==2.1.0 && \
        uv pip install git+https://github.com/huggingface/optimum-intel.git@ff99d6e13774841bdd17ac0d4c8bd2d181cf7c27

RUN uv pip install --pre -U openvino-genai openvino-tokenizers nncf \
